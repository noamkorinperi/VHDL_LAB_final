...
begin
    ...
    begin
        ...
        assert cpu_rdata = x"AABBCCDD" report "Stage 1: DTCM read mux failed" severity failure;
        ...
        assert cpu_rdata = x"0000005A" report "Stage 1: MMIO read mux failed" severity failure;

        mmio_hit <= '0'; wait for 1 ns;
        assert unmapped = '1' and cpu_rdata = x"00000000"
            report "Stage 1: unimplemented MMIO behavior failed" severity failure;

        cpu_addr <= x"00004000"; wait for 1 ns;
