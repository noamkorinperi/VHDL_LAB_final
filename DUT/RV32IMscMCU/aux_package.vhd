...
---------------------------------------------------------  
	component control is
		...
		MULOp_ctrl_o        : OUT   STD_LOGIC;	-- Added for M-Ext
		DivOp_ctrl_o        : OUT   STD_LOGIC_VECTOR(2 DOWNTO 0);
...
---------------------------------------------------------		
	component Execute is
		...
		PORT(	
			...
			MULOp_ctrl_i    : IN    STD_LOGIC;	-- Added for M-Ext
