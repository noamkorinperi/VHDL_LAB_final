...
-- remu
	...
	-- Divider operation encoding used between CONTROL and the accelerator.
	constant DIVOP_NONE : STD_LOGIC_VECTOR(2 DOWNTO 0) := "000";
	constant DIVOP_DIV  : STD_LOGIC_VECTOR(2 DOWNTO 0) := "001";
	constant DIVOP_DIVU : STD_LOGIC_VECTOR(2 DOWNTO 0) := "010";
	constant DIVOP_REM  : STD_LOGIC_VECTOR(2 DOWNTO 0) := "011";
	constant DIVOP_REMU : STD_LOGIC_VECTOR(2 DOWNTO 0) := "100";
