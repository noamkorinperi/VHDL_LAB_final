...
--==================================================================================================================
	constant G_MODELSIM					: integer	:= 0;						-- options{1=MODELSIM,0=FPGA} (FPGA build; tb_RV32IM_pipeline overrides MODELSIM=>1 for sim)
	...
	constant G_PLL_DIV		 			: NATURAL	:= 1;						-- relavant only when G_MODELSIM=0
	constant G_PLL_MUL		 			: NATURAL	:= 2;						-- relavant only when G_MODELSIM=0 	
