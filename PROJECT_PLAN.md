...
עודכן לאחרונה: 27.08.2026 IDT - התאמות פורום; אימות פיזי לענף החדש ממתין
...
| זמן עדכון אחרון | 27.08.2026 IDT |
| שלב נוכחי | התאמות forum-compliance הושלמו אוטומטית; אימות כרטיס ממתין |
| הושלם | רגרסיית 9/9, בדיקת פסיקה באמצע DIV, Quartus Full Compilation ו־TimeQuest fully constrained |
| הפעולה הבאה | לצרוב את SOF מהענף ולחזור על בדיקות reset, compare, PWM, DIV ו־REM |
| חסם נוכחי | אין גישה פיזית לכרטיס במהלך הכנת הענף |
| Quartus | 0 errors; TimeQuest 0 warnings; worst setup ‏+0.474 ns ו־worst hold ‏+0.160 ns |
...
### 27.08.2026 IDT - התאמות לפי שאלות ותשובות הפורום

- נוספו שלושה מופעי PLL לוגיים נפרדים: MCLK, SMCLK ו־DIVCLK.
- ה־interconnect הוסב ל־DATA BUS דו־כיווני עם `Z`; ‏TYPE נוהג עליו בזמן INTA.
- אירועי KEY נוצרים בשחרור ללא debounce/synchronizer נוסף, בהתאם להבהרת המדריך.
- IFG נוצר רק כאשר IE פעיל ומתנקה בביטול IE; ‏BTCAPR הוא R/W; בחירת HEX משתמשת ב־A0.
- נוספה בדיקת קבלה לפסיקה שמגיעה באמצע DIV ומאמתת retirement לפני INTA.
- ModelSim, Quartus ו־TimeQuest עברו. השינויים **טרם עברו אימות פיזי**;
  הראיות הפיזיות מ־26.08.2026 שייכות ל־`main` בלבד.
