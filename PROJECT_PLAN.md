...
עודכן לאחרונה: 12.08.2026 21:53 IDT - נוסף שלב 5.5 לבדיקת KEY ו-PWM על החומרה
...
| זמן עדכון אחרון | 12.08.2026 21:53 IDT |
...
| הפעולה הבאה | להריץ לפי הסדר את שבע בדיקות ModelSim של שלבים 0–3 ולתעד PASS/log/Wave |
